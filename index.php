...
<div class="row align-items-center mb-5 py-5" style="background: linear-gradient(rgba(245, 245, 220, 0.9), rgba(245, 245, 220, 0.9)), url('https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?auto=format&fit=crop&q=80&w=2070') center/cover; border-radius: 20px;">
    <div class="col-md-8 offset-md-2 text-center">
        ...
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
            <a href="products.php" class="btn btn-primary btn-lg px-4 gap-3 rounded-pill">Lihat Menu</a>
            <a href="register.php" class="btn btn-outline-primary btn-lg px-4 rounded-pill">Daftar Sekarang</a>
        </div>
    </div>
</div>
...
<div class="row mb-4">
    <div class="col-md-12 text-center">
        <h3 class="section-title d-inline-block">Kenapa Memilih Restoran Prime?</h3>
    </div>
</div>
...
<div class="row g-4 mb-5 text-center">
    <div class="col-md-4">
        <div class="card p-4 h-100 border-0 shadow-sm">
            ...
            <h5>Bahan Segar</h5>
            <p class="text-muted">Kami menggunakan bahan-bahan organik dan segar langsung dari petani lokal.</p>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card p-4 h-100 border-0 shadow-sm">
            ...
            <p class="text-muted">Hidangan disiapkan oleh tim koki berpengalaman di restoran bintang lima.</p>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card p-4 h-100 border-0 shadow-sm">
            ...
            <p class="text-muted">Layanan antar yang cepat dan aman untuk menjaga kualitas rasa makanan.</p>
        </div>
    </div>
</div>
...
<nav aria-label="Page navigation">
  <ul class="pagination justify-content-center">
    ...
    <li class="page-item <?php echo $page == $i ? 'active' : ''; ?>">
        <a class="page-link" href="index.php?page=<?php echo $i; ?><?php echo $category_id ? '&category='.$category_id : ''; ?><?php echo $search ? '&search='.$search : ''; ?>">
            <?php echo $i; ?>
        </a>
    </li>
    <?php endfor; ?>
